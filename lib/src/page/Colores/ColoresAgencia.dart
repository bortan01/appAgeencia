...
class ColorAgencia {
  ...
  static const Color celeVerde = Color(0xff009688);
  static const Color teal = Color(0xff008080);
  static const Color col4 = Color(0xff0FD391);

  static const Color blue2 = Color(0xff81d4fa);
  static const Color blue1 = Color(0xff03a9f4);
  static const Color blue3 = Color(0xff039be5);
  static const Color col3 = Color(0xff3A84D5);
  static const Color blue4 = Color(0xff0288d1);
  static const Color blue5 = Color(0xff01579b);
  static const Color col5 = Color(0xff005681);
