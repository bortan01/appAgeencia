...
DetalleTurModel detalleTurFromJson(String str) =>
    DetalleTurModel.fromJson(json.decode(str));
...
class DetalleTurModel {
  ...
  factory DetalleTurModel.fromJson(Map<String, dynamic> json) =>
      DetalleTurModel(
  ...
  Map<String, dynamic> toJson() => {
        ...
        "descripcionProducto": descripcionProducto.toString(),
