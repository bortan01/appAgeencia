...
CotizacionesPaquetesCliente cotizacionesPaquetesClienteFromJson(String str) =>
    CotizacionesPaquetesCliente.fromJson(json.decode(str));
...
class Cotizacione {
  ...
  factory Cotizacione.fromJson(Map<String, dynamic> json) => Cotizacione(
        ...
        fechaPeticion: json["fechaPeticion"] == null ? null : DateTime.parse(json["fechaPeticion"]),
        fechaRespuesta: json["fechaRespuesta"] == null ? null : DateTime.parse(json["fechaRespuesta"]),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "fechaRespuesta":
            "${fechaRespuesta.year.toString().padLeft(4, '0')}-${fechaRespuesta.month.toString().padLeft(2, '0')}-${fechaRespuesta.day.toString().padLeft(2, '0')}",
